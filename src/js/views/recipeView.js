...
const createIngredient = ingredient => `
                    <li class="recipe__item">
                        ...
                        <div class="recipe__ingredient">
                            ...
                            ${ingredient.ingredient} (about 
                                <span class="recipe__weight">${ingredient.weight}</span>g)
                        </div>
                    </li>
`;
...
// this function updates the servings and incredents on UI.
export const updateServingsIngredients = recipe => {
    ...
    // update ingredients weight
    const weightElements = Array.from(document.querySelectorAll('.recipe__weight'));
    weightElements.forEach((el, i) => {
        el.textContent = recipe.ingredients[i].weight;
    })
};